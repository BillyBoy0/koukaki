...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="#story" class="story fadeInUp">
            <h2 class="slideInUp">L'histoire</h2>
        ...
        <section id="studio" class="studio scrollFade">
            <h2 class="slideInUp" >Studio Koukaki</h2>
            <div>
        ...
        <section id="oscars" class="oscars scrollFade">
            <h3 class="slideInUp">Fleurs d’oranger & chats errants<br>est nominé aux Oscars Short<br>Film Animated de 2022 !</h3>
